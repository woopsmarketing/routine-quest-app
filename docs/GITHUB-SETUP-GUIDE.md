...
지금은 `.github/branch-protection.yml` 파일만 있는 상태입니다. GitHub에서 실제로 브랜치 보호를
활성화하려면 **수동 설정**이 필요합니다.
...
이제 Cursor와 Claude Code를 활용한 효율적인 협업 개발이 가능합니다. 문제가 발생하면 이 가이드를
참조하거나 GitHub Issues를 활용하세요!
