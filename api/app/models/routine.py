...
class Routine(Base):
    ...
    avg_completion_time = Column(Integer, default=0, nullable=False)  # 평균 완료 시간(초)
    ...
    steps = relationship("Step", back_populates="routine", cascade="all, delete-orphan", order_by="Step.order")
...
class Step(Base):
    ...
    checkins = relationship("Checkin", back_populates="step", cascade="all, delete-orphan")
